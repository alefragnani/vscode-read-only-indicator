...
Unsure where to begin contributing? You can start by looking through the [`help wanted`](https://github.com/alefragnani/vscode-read-only-indicator/labels/help%20wanted) issues.
...
1. Open the `vscode-read-only-indicator` folder
